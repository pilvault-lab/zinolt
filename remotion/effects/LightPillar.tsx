...
const LightPillar: React.FC<Props> = ({
  topColor = "#5227FF",
  bottomColor = "#FF9FFC",
  intensity = 1.0,
  rotationSpeed = 0.3,
  ...
  useEffect(() => {
    ...
    materialRef.current.uniforms.uTopColor.value = new THREE.Vector3(
      c.r,
      c.g,
      c.b,
    );
  ...
  useEffect(() => {
    ...
    materialRef.current.uniforms.uBottomColor.value = new THREE.Vector3(
      c.r,
      c.g,
      c.b,
    );
